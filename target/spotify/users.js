...
export function getUsersByUserid(){return request({url: 'http://api.spotify.com/v1/users/${user_id}',method:'get',params:{},}).then(res => {
		...
		return res.data
	})}export function getUsersByUseridPlaylistsByPlaylistid(fields,market,){return request({url: 'http://api.spotify.com/v1/users/${user_id}/playlists/${playlist_id}',method:'get',params:{fields,market,},}).then(res => {
		return res.data
	})}export function putUsersByUseridPlaylistsByPlaylistid(data){return request({url: 'http://api.spotify.com/v1/users/${user_id}/playlists/${playlist_id}',method:'put',data,params:{},}).then(res => {
		return res.data
