...
export function getBrowseCategories(limit,offset,country,locale,){return request({url: 'http://api.spotify.com/v1/browse/categories',method:'get',params:{limit,offset,country,locale,},}).then(res => {
		return res.data
	})}export function getBrowseCategoriesByCategoryid(country,locale,){return request({url: 'http://api.spotify.com/v1/browse/categories/${category_id}',method:'get',params:{country,locale,},}).then(res => {
		return res.data
