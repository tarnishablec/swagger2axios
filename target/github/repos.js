...
export function getAssigneesByAssigneeFromReposByOwnerByRepo(owner,repo,assignee,){
 return request({url: `http://api.github.com/repos/${owner}/${repo}/assignees/${assignee}`,method:'get',}).then(res => {
		return res.data
	})}
...
export function deleteCollaboratorsByUserFromReposByOwnerByRepo(owner,repo,user,){
 return request({url: `http://api.github.com/repos/${owner}/${repo}/collaborators/${user}`,method:'delete',}).then(res => {
		return res.data
	})}
export function getCollaboratorsByUserFromReposByOwnerByRepo(owner,repo,user,){
 return request({url: `http://api.github.com/repos/${owner}/${repo}/collaborators/${user}`,method:'get',}).then(res => {
		return res.data
	})}
export function putCollaboratorsByUserFromReposByOwnerByRepo(owner,repo,user,){
 return request({url: `http://api.github.com/repos/${owner}/${repo}/collaborators/${user}`,method:'put',}).then(res => {
		return res.data
	})}
...
export function deleteCommentsByCommentIdFromReposByOwnerByRepo(owner,repo,commentId,){
 return request({url: `http://api.github.com/repos/${owner}/${repo}/comments/${commentId}`,method:'delete',}).then(res => {
		return res.data
	})}
export function getCommentsByCommentIdFromReposByOwnerByRepo(owner,repo,commentId,){
 return request({url: `http://api.github.com/repos/${owner}/${repo}/comments/${commentId}`,method:'get',}).then(res => {
		return res.data
	})}
export function patchCommentsByCommentIdFromReposByOwnerByRepo(owner,repo,commentId,data,){
 return request({url: `http://api.github.com/repos/${owner}/${repo}/comments/${commentId}`,method:'patch',data,}).then(res => {
		return res.data
	})}
...
export function getStatusFromReposByOwnerByRepoCommitsByRef(owner,repo,ref,){
 return request({url: `http://api.github.com/repos/${owner}/${repo}/commits/${ref}/status`,method:'get',}).then(res => {
		return res.data
	})}
...
export function getCommentsFromReposByOwnerByRepoCommitsByShaCode(owner,repo,shaCode,){
 return request({url: `http://api.github.com/repos/${owner}/${repo}/commits/${shaCode}/comments`,method:'get',}).then(res => {
		return res.data
	})}
export function postCommentsFromReposByOwnerByRepoCommitsByShaCode(owner,repo,shaCode,data,){
 return request({url: `http://api.github.com/repos/${owner}/${repo}/commits/${shaCode}/comments`,method:'post',data,}).then(res => {
		return res.data
	})}
export function getCompareByBaseIdByHeadIdFromReposByOwnerByRepo(owner,repo,baseId,headId,){
 return request({url: `http://api.github.com/repos/${owner}/${repo}/compare/${baseId}...${headId}`,method:'get',}).then(res => {
		return res.data
	})}
export function deleteContentsByPathFromReposByOwnerByRepo(owner,repo,path,data,){
 return request({url: `http://api.github.com/repos/${owner}/${repo}/contents/${path}`,method:'delete',data,}).then(res => {
		return res.data
	})}
export function getContentsByPathFromReposByOwnerByRepo(owner,repo,params,){
 return request({url: `http://api.github.com/repos/${owner}/${repo}/contents/${path}`,method:'get',params,}).then(res => {
		return res.data
	})}
export function putContentsByPathFromReposByOwnerByRepo(owner,repo,path,data,){
 return request({url: `http://api.github.com/repos/${owner}/${repo}/contents/${path}`,method:'put',data,}).then(res => {
		return res.data
	})}
export function getContributorsFromReposByOwnerByRepo(owner,repo,params,){
 return request({url: `http://api.github.com/repos/${owner}/${repo}/contributors`,method:'get',params,}).then(res => {
		return res.data
	})}
...
export function getStatusesFromReposByOwnerByRepoDeploymentsById(owner,repo,id,){
 return request({url: `http://api.github.com/repos/${owner}/${repo}/deployments/${id}/statuses`,method:'get',}).then(res => {
		return res.data
	})}
export function postStatusesFromReposByOwnerByRepoDeploymentsById(owner,repo,id,data,){
 return request({url: `http://api.github.com/repos/${owner}/${repo}/deployments/${id}/statuses`,method:'post',data,}).then(res => {
		return res.data
	})}
...
export function deleteDownloadsByDownloadIdFromReposByOwnerByRepo(owner,repo,downloadId,){
 return request({url: `http://api.github.com/repos/${owner}/${repo}/downloads/${downloadId}`,method:'delete',}).then(res => {
		return res.data
	})}
export function getDownloadsByDownloadIdFromReposByOwnerByRepo(owner,repo,downloadId,){
 return request({url: `http://api.github.com/repos/${owner}/${repo}/downloads/${downloadId}`,method:'get',}).then(res => {
		return res.data
	})}
...
export function getBlobsByShaCodeFromReposByOwnerByRepoGit(owner,repo,shaCode,){
 return request({url: `http://api.github.com/repos/${owner}/${repo}/git/blobs/${shaCode}`,method:'get',}).then(res => {
		return res.data
	})}
...
export function getCommitsByShaCodeFromReposByOwnerByRepoGit(owner,repo,shaCode,){
 return request({url: `http://api.github.com/repos/${owner}/${repo}/git/commits/${shaCode}`,method:'get',}).then(res => {
		return res.data
	})}
...
export function patchRefsByRefFromReposByOwnerByRepoGit(owner,repo,ref,data,){
 return request({url: `http://api.github.com/repos/${owner}/${repo}/git/refs/${ref}`,method:'patch',data,}).then(res => {
		return res.data
	})}
...
export function getTagsByShaCodeFromReposByOwnerByRepoGit(owner,repo,shaCode,){
 return request({url: `http://api.github.com/repos/${owner}/${repo}/git/tags/${shaCode}`,method:'get',}).then(res => {
		return res.data
	})}
...
export function getTreesByShaCodeFromReposByOwnerByRepoGit(owner,repo,shaCode,params,){
 return request({url: `http://api.github.com/repos/${owner}/${repo}/git/trees/${shaCode}`,method:'get',params,}).then(res => {
		return res.data
	})}
...
export function patchHooksByHookIdFromReposByOwnerByRepo(owner,repo,hookId,data,){
 return request({url: `http://api.github.com/repos/${owner}/${repo}/hooks/${hookId}`,method:'patch',data,}).then(res => {
		return res.data
	})}
export function postTestsFromReposByOwnerByRepoHooksByHookId(owner,repo,hookId,){
 return request({url: `http://api.github.com/repos/${owner}/${repo}/hooks/${hookId}/tests`,method:'post',}).then(res => {
		return res.data
	})}
...
export function getCommentsFromReposByOwnerByRepoIssues(owner,repo,params,){
 return request({url: `http://api.github.com/repos/${owner}/${repo}/issues/comments`,method:'get',params,}).then(res => {
		return res.data
	})}
export function deleteCommentsByCommentIdFromReposByOwnerByRepoIssues(owner,repo,commentId,){
 return request({url: `http://api.github.com/repos/${owner}/${repo}/issues/comments/${commentId}`,method:'delete',}).then(res => {
		return res.data
	})}
export function getCommentsByCommentIdFromReposByOwnerByRepoIssues(owner,repo,commentId,){
 return request({url: `http://api.github.com/repos/${owner}/${repo}/issues/comments/${commentId}`,method:'get',}).then(res => {
		return res.data
	})}
export function patchCommentsByCommentIdFromReposByOwnerByRepoIssues(owner,repo,commentId,data,){
 return request({url: `http://api.github.com/repos/${owner}/${repo}/issues/comments/${commentId}`,method:'patch',data,}).then(res => {
		return res.data
	})}
...
export function getEventsByEventIdFromReposByOwnerByRepoIssues(owner,repo,eventId,){
 return request({url: `http://api.github.com/repos/${owner}/${repo}/issues/events/${eventId}`,method:'get',}).then(res => {
		return res.data
	})}
...
export function patchIssuesByNumberFromReposByOwnerByRepo(owner,repo,number,data,){
 return request({url: `http://api.github.com/repos/${owner}/${repo}/issues/${number}`,method:'patch',data,}).then(res => {
		return res.data
	})}
export function getCommentsFromReposByOwnerByRepoIssuesByNumber(owner,repo,number,){
 return request({url: `http://api.github.com/repos/${owner}/${repo}/issues/${number}/comments`,method:'get',}).then(res => {
		return res.data
	})}
export function postCommentsFromReposByOwnerByRepoIssuesByNumber(owner,repo,number,data,){
 return request({url: `http://api.github.com/repos/${owner}/${repo}/issues/${number}/comments`,method:'post',data,}).then(res => {
		return res.data
	})}
export function getEventsFromReposByOwnerByRepoIssuesByNumber(owner,repo,number,){
 return request({url: `http://api.github.com/repos/${owner}/${repo}/issues/${number}/events`,method:'get',}).then(res => {
		return res.data
	})}
export function deleteLabelsFromReposByOwnerByRepoIssuesByNumber(owner,repo,number,){
 return request({url: `http://api.github.com/repos/${owner}/${repo}/issues/${number}/labels`,method:'delete',}).then(res => {
		return res.data
	})}
export function getLabelsFromReposByOwnerByRepoIssuesByNumber(owner,repo,number,){
 return request({url: `http://api.github.com/repos/${owner}/${repo}/issues/${number}/labels`,method:'get',}).then(res => {
		return res.data
	})}
export function postLabelsFromReposByOwnerByRepoIssuesByNumber(owner,repo,number,data,){
 return request({url: `http://api.github.com/repos/${owner}/${repo}/issues/${number}/labels`,method:'post',data,}).then(res => {
		return res.data
	})}
export function putLabelsFromReposByOwnerByRepoIssuesByNumber(owner,repo,number,data,){
 return request({url: `http://api.github.com/repos/${owner}/${repo}/issues/${number}/labels`,method:'put',data,}).then(res => {
		return res.data
	})}
export function deleteLabelsByNameFromReposByOwnerByRepoIssuesByNumber(owner,repo,number,name,){
 return request({url: `http://api.github.com/repos/${owner}/${repo}/issues/${number}/labels/${name}`,method:'delete',}).then(res => {
		return res.data
	})}
...
export function patchLabelsByNameFromReposByOwnerByRepo(owner,repo,name,data,){
 return request({url: `http://api.github.com/repos/${owner}/${repo}/labels/${name}`,method:'patch',data,}).then(res => {
		return res.data
	})}
...
export function deleteMilestonesByNumberFromReposByOwnerByRepo(owner,repo,number,){
 return request({url: `http://api.github.com/repos/${owner}/${repo}/milestones/${number}`,method:'delete',}).then(res => {
		return res.data
	})}
export function getMilestonesByNumberFromReposByOwnerByRepo(owner,repo,number,){
 return request({url: `http://api.github.com/repos/${owner}/${repo}/milestones/${number}`,method:'get',}).then(res => {
		return res.data
	})}
export function patchMilestonesByNumberFromReposByOwnerByRepo(owner,repo,number,data,){
 return request({url: `http://api.github.com/repos/${owner}/${repo}/milestones/${number}`,method:'patch',data,}).then(res => {
		return res.data
	})}
export function getLabelsFromReposByOwnerByRepoMilestonesByNumber(owner,repo,number,){
 return request({url: `http://api.github.com/repos/${owner}/${repo}/milestones/${number}/labels`,method:'get',}).then(res => {
		return res.data
	})}
export function getNotificationsFromReposByOwnerByRepo(owner,repo,params,){
 return request({url: `http://api.github.com/repos/${owner}/${repo}/notifications`,method:'get',params,}).then(res => {
		return res.data
	})}
export function putNotificationsFromReposByOwnerByRepo(owner,repo,data,){
 return request({url: `http://api.github.com/repos/${owner}/${repo}/notifications`,method:'put',data,}).then(res => {
		return res.data
	})}
...
export function getCommentsFromReposByOwnerByRepoPulls(owner,repo,params,){
 return request({url: `http://api.github.com/repos/${owner}/${repo}/pulls/comments`,method:'get',params,}).then(res => {
		return res.data
	})}
export function deleteCommentsByCommentIdFromReposByOwnerByRepoPulls(owner,repo,commentId,){
 return request({url: `http://api.github.com/repos/${owner}/${repo}/pulls/comments/${commentId}`,method:'delete',}).then(res => {
		return res.data
	})}
export function getCommentsByCommentIdFromReposByOwnerByRepoPulls(owner,repo,commentId,){
 return request({url: `http://api.github.com/repos/${owner}/${repo}/pulls/comments/${commentId}`,method:'get',}).then(res => {
		return res.data
	})}
export function patchCommentsByCommentIdFromReposByOwnerByRepoPulls(owner,repo,commentId,data,){
 return request({url: `http://api.github.com/repos/${owner}/${repo}/pulls/comments/${commentId}`,method:'patch',data,}).then(res => {
		return res.data
	})}
...
export function patchPullsByNumberFromReposByOwnerByRepo(owner,repo,number,data,){
 return request({url: `http://api.github.com/repos/${owner}/${repo}/pulls/${number}`,method:'patch',data,}).then(res => {
		return res.data
	})}
export function getCommentsFromReposByOwnerByRepoPullsByNumber(owner,repo,number,){
 return request({url: `http://api.github.com/repos/${owner}/${repo}/pulls/${number}/comments`,method:'get',}).then(res => {
		return res.data
	})}
export function postCommentsFromReposByOwnerByRepoPullsByNumber(owner,repo,number,data,){
 return request({url: `http://api.github.com/repos/${owner}/${repo}/pulls/${number}/comments`,method:'post',data,}).then(res => {
		return res.data
	})}
export function getCommitsFromReposByOwnerByRepoPullsByNumber(owner,repo,number,){
 return request({url: `http://api.github.com/repos/${owner}/${repo}/pulls/${number}/commits`,method:'get',}).then(res => {
		return res.data
	})}
export function getFilesFromReposByOwnerByRepoPullsByNumber(owner,repo,number,){
 return request({url: `http://api.github.com/repos/${owner}/${repo}/pulls/${number}/files`,method:'get',}).then(res => {
		return res.data
	})}
export function getMergeFromReposByOwnerByRepoPullsByNumber(owner,repo,number,){
 return request({url: `http://api.github.com/repos/${owner}/${repo}/pulls/${number}/merge`,method:'get',}).then(res => {
		return res.data
	})}
export function putMergeFromReposByOwnerByRepoPullsByNumber(owner,repo,number,data,){
 return request({url: `http://api.github.com/repos/${owner}/${repo}/pulls/${number}/merge`,method:'put',data,}).then(res => {
		return res.data
	})}
...
export function deleteAssetsByIdFromReposByOwnerByRepoReleases(owner,repo,id,){
 return request({url: `http://api.github.com/repos/${owner}/${repo}/releases/assets/${id}`,method:'delete',}).then(res => {
		return res.data
	})}
export function getAssetsByIdFromReposByOwnerByRepoReleases(owner,repo,id,){
 return request({url: `http://api.github.com/repos/${owner}/${repo}/releases/assets/${id}`,method:'get',}).then(res => {
		return res.data
	})}
export function patchAssetsByIdFromReposByOwnerByRepoReleases(owner,repo,id,data,){
 return request({url: `http://api.github.com/repos/${owner}/${repo}/releases/assets/${id}`,method:'patch',data,}).then(res => {
		return res.data
	})}
...
export function patchReleasesByIdFromReposByOwnerByRepo(owner,repo,id,data,){
 return request({url: `http://api.github.com/repos/${owner}/${repo}/releases/${id}`,method:'patch',data,}).then(res => {
		return res.data
	})}
export function getAssetsFromReposByOwnerByRepoReleasesById(owner,repo,id,){
 return request({url: `http://api.github.com/repos/${owner}/${repo}/releases/${id}/assets`,method:'get',}).then(res => {
		return res.data
	})}
...
export function getCodefrequencyFromReposByOwnerByRepoStats(owner,repo,){
 return request({url: `http://api.github.com/repos/${owner}/${repo}/stats/code_frequency`,method:'get',}).then(res => {
		return res.data
	})}
export function getCommitactivityFromReposByOwnerByRepoStats(owner,repo,){
 return request({url: `http://api.github.com/repos/${owner}/${repo}/stats/commit_activity`,method:'get',}).then(res => {
		return res.data
	})}
...
export function getParticipationFromReposByOwnerByRepoStats(owner,repo,){
 return request({url: `http://api.github.com/repos/${owner}/${repo}/stats/participation`,method:'get',}).then(res => {
		return res.data
	})}
...
export function postStatusesByRefFromReposByOwnerByRepo(owner,repo,ref,data,){
 return request({url: `http://api.github.com/repos/${owner}/${repo}/statuses/${ref}`,method:'post',data,}).then(res => {
		return res.data
	})}
